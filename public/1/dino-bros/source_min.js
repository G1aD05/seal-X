...
var Storage={};Storage.VERSION=1;Storage.PATH_VERSION='com.martinmagni.monstermatch/version';Storage.PREFIX='com.martinmagni.monstermatch/data/';Storage.LEGACY_PREFIX='/';Storage.stringToHex=function(str){var hex='';for(var i=0;i<str.length;i++){hex+=str.charCodeAt(i).toString(16)+" ";}
return hex;}
...
function pokiSendLevelData(){navigator.sendBeacon('https://leveldata.poki.io/fancade-5E72248DB8B551A1','599a3c43-b4af-45bc-975d-5f09a02c927a');}

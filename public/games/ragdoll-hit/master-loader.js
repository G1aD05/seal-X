(() => {
    ...
    try {
        try {
            ...
            c = function(t) {
                for (var n, o = "0123456789ABCDEF", r = "", e = 0; e < t.length; e++) n = t.charCodeAt(e), r += o.charAt(n >>> 4 & 15) + o.charAt(15 & n);
                return r
            }(function(t) {
                for (var n = "", o = 0; o < 32 * t.length; o += 8) n += String.fromCharCode(t[o >> 5] >>> o % 32 & 255);
                return n
            }(function(t, c) {
        ...
        window.IDBObjectStore.prototype.put = function(...t) {
            if ("/idbfs" === this.transaction.db.name) {
                try {
                    s || (n = t[1], s = n.split("/idbfs/")[1].split("/")[0], localStorage.setItem("savegame_idbfs_hash", s))
                } catch (t) {}
                const o = [...t];

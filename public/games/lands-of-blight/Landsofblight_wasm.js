...
function _HtmlHtmlUtilsCanvasFocus() {
    document.getElementById("canvas").focus()
}

function _HtmlHtmlUtilsCanvasHaveFocus() {
    console.log(document.activeElement.id);
    return document.activeElement.id === "canvas"
}

function _HtmlHtmlUtilsHideBg() {
    document.getElementById("canvas-bg").style.display = "none";
    document.getElementById("canvas-bg").style.background = ""
}
var JsToDef = {
        ...
        if (JsToDef._callback_object) {
            ...
            switch (typeof message) {
                ...
                case "string":
                    ...
                    wasmTable.get(JsToDef._callback_string)(msg_id, msg, msg_arr.length);
                    Module._free(msg);
                    break;
                case "object":
                    if (message instanceof ArrayBuffer || ArrayBuffer.isView(message)) {
                        ...
                        wasmTable.get(JsToDef._callback_object)(msg_id, msg, msg_arr.length);
                        Module._free(msg)
                    }
                    break;
                case "boolean":
...
var asmLibraryArg = {
    "gi": _HtmlHtmlUtilsCanvasFocus,
    "fi": _HtmlHtmlUtilsCanvasHaveFocus,
    "ei": _HtmlHtmlUtilsHideBg,
    "di": _JsToDef_RegisterCallbacks,
    "ci": _JsToDef_RemoveCallbacks,
    "bi": _PokiSdkJs_AddParameterForURL,
    "ai": _PokiSdkJs_CaptureError,
    "$h": _PokiSdkJs_CommercialBreak,
    "_h": _PokiSdkJs_GameplayStart,
    "Zh": _PokiSdkJs_GameplayStop,
    "Yh": _PokiSdkJs_GetURLParam,
    "Xh": _PokiSdkJs_IsAdBlocked,
    "Wh": _PokiSdkJs_RewardedBreak,
    "Vh": _PokiSdkJs_SetDebug,
    "Uh": _PokiSdkJs_ShareableURL,
    "b": ___assert_fail,
    "Th": ___clock_gettime,
    "Sh": ___gmtime_r,
    "Rh": ___localtime_r,
    ...
    "zh": _clock,
    "yh": _difftime,
    "xh": _dmDeviceJSFreeBufferSlots,
    "wh": _dmDeviceJSOpen,
    "vh": _dmDeviceJSQueue,
    "uh": _dmGetDeviceSampleRate,
    ...
    "kh": _emscripten_glBeginQuery,
    "jh": _emscripten_glBeginQueryEXT,
    "ih": _emscripten_glBeginTransformFeedback,
    "hh": _emscripten_glBindAttribLocation,
    "gh": _emscripten_glBindBuffer,
    "fh": _emscripten_glBindBufferBase,
    "eh": _emscripten_glBindBufferRange,
    "dh": _emscripten_glBindFramebuffer,
    "ch": _emscripten_glBindRenderbuffer,
    "bh": _emscripten_glBindSampler,
    "ah": _emscripten_glBindTexture,
    "$g": _emscripten_glBindTransformFeedback,
    "_g": _emscripten_glBindVertexArray,
    "Zg": _emscripten_glBindVertexArrayOES,
    "Yg": _emscripten_glBlendColor,
    "Xg": _emscripten_glBlendEquation,
    "Wg": _emscripten_glBlendEquationSeparate,
    "Vg": _emscripten_glBlendFunc,
    "Ug": _emscripten_glBlendFuncSeparate,
    "Tg": _emscripten_glBlitFramebuffer,
    "Sg": _emscripten_glBufferData,
    "Rg": _emscripten_glBufferSubData,
    "Qg": _emscripten_glCheckFramebufferStatus,
    "Pg": _emscripten_glClear,
    "Og": _emscripten_glClearBufferfi,
    "Ng": _emscripten_glClearBufferfv,
    "Mg": _emscripten_glClearBufferiv,
    "Lg": _emscripten_glClearBufferuiv,
    "Kg": _emscripten_glClearColor,
    "Jg": _emscripten_glClearDepthf,
    "Ig": _emscripten_glClearStencil,
    "Hg": _emscripten_glClientWaitSync,
    "Gg": _emscripten_glColorMask,
    "Fg": _emscripten_glCompileShader,
    "Eg": _emscripten_glCompressedTexImage2D,
    "Dg": _emscripten_glCompressedTexImage3D,
    "Cg": _emscripten_glCompressedTexSubImage2D,
    "Bg": _emscripten_glCompressedTexSubImage3D,
    "Ag": _emscripten_glCopyBufferSubData,
    "zg": _emscripten_glCopyTexImage2D,
    "yg": _emscripten_glCopyTexSubImage2D,
    "xg": _emscripten_glCopyTexSubImage3D,
    "wg": _emscripten_glCreateProgram,
    "vg": _emscripten_glCreateShader,
    "ug": _emscripten_glCullFace,
    "tg": _emscripten_glDeleteBuffers,
    "sg": _emscripten_glDeleteFramebuffers,
    "rg": _emscripten_glDeleteProgram,
    "qg": _emscripten_glDeleteQueries,
    "pg": _emscripten_glDeleteQueriesEXT,
    "og": _emscripten_glDeleteRenderbuffers,
    "ng": _emscripten_glDeleteSamplers,
    "mg": _emscripten_glDeleteShader,
    "lg": _emscripten_glDeleteSync,
    "kg": _emscripten_glDeleteTextures,
    "jg": _emscripten_glDeleteTransformFeedbacks,
    "ig": _emscripten_glDeleteVertexArrays,
    "hg": _emscripten_glDeleteVertexArraysOES,
    "gg": _emscripten_glDepthFunc,
    "fg": _emscripten_glDepthMask,
    "eg": _emscripten_glDepthRangef,
    "dg": _emscripten_glDetachShader,
    "cg": _emscripten_glDisable,
    "bg": _emscripten_glDisableVertexAttribArray,
    "ag": _emscripten_glDrawArrays,
    "$f": _emscripten_glDrawArraysInstanced,
    "_f": _emscripten_glDrawArraysInstancedANGLE,
    "Zf": _emscripten_glDrawArraysInstancedARB,
    "Yf": _emscripten_glDrawArraysInstancedEXT,
    "Xf": _emscripten_glDrawArraysInstancedNV,
    "Wf": _emscripten_glDrawBuffers,
    "Vf": _emscripten_glDrawBuffersEXT,
    "Uf": _emscripten_glDrawBuffersWEBGL,
    "Tf": _emscripten_glDrawElements,
    "Sf": _emscripten_glDrawElementsInstanced,
    "Rf": _emscripten_glDrawElementsInstancedANGLE,
    "Qf": _emscripten_glDrawElementsInstancedARB,
    "Pf": _emscripten_glDrawElementsInstancedEXT,
    "Of": _emscripten_glDrawElementsInstancedNV,
    "Nf": _emscripten_glDrawRangeElements,
    "Mf": _emscripten_glEnable,
    "Lf": _emscripten_glEnableVertexAttribArray,
    "Kf": _emscripten_glEndQuery,
    "Jf": _emscripten_glEndQueryEXT,
    "If": _emscripten_glEndTransformFeedback,
    "Hf": _emscripten_glFenceSync,
    "Gf": _emscripten_glFinish,
    "Ff": _emscripten_glFlush,
    "Ef": _emscripten_glFramebufferRenderbuffer,
    "Df": _emscripten_glFramebufferTexture2D,
    "Cf": _emscripten_glFramebufferTextureLayer,
    "Bf": _emscripten_glFrontFace,
    "Af": _emscripten_glGenBuffers,
    "zf": _emscripten_glGenFramebuffers,
    "yf": _emscripten_glGenQueries,
    "xf": _emscripten_glGenQueriesEXT,
    "wf": _emscripten_glGenRenderbuffers,
    "vf": _emscripten_glGenSamplers,
    "uf": _emscripten_glGenTextures,
    "tf": _emscripten_glGenTransformFeedbacks,
    "sf": _emscripten_glGenVertexArrays,
    "rf": _emscripten_glGenVertexArraysOES,
    ...
    "mf": _emscripten_glGetActiveUniformBlockiv,
    "lf": _emscripten_glGetActiveUniformsiv,
    ...
    "$e": _emscripten_glGetInteger64v,
    "_e": _emscripten_glGetIntegeri_v,
    "Ze": _emscripten_glGetIntegerv,
    "Ye": _emscripten_glGetInternalformativ,
    "Xe": _emscripten_glGetProgramBinary,
    "We": _emscripten_glGetProgramInfoLog,
    "Ve": _emscripten_glGetProgramiv,
    "Ue": _emscripten_glGetQueryObjecti64vEXT,
    "Te": _emscripten_glGetQueryObjectivEXT,
    "Se": _emscripten_glGetQueryObjectui64vEXT,
    "Re": _emscripten_glGetQueryObjectuiv,
    "Qe": _emscripten_glGetQueryObjectuivEXT,
    "Pe": _emscripten_glGetQueryiv,
    "Oe": _emscripten_glGetQueryivEXT,
    "Ne": _emscripten_glGetRenderbufferParameteriv,
    "Me": _emscripten_glGetSamplerParameterfv,
    "Le": _emscripten_glGetSamplerParameteriv,
    "Ke": _emscripten_glGetShaderInfoLog,
    "Je": _emscripten_glGetShaderPrecisionFormat,
    "Ie": _emscripten_glGetShaderSource,
    "He": _emscripten_glGetShaderiv,
    "Ge": _emscripten_glGetString,
    "Fe": _emscripten_glGetStringi,
    "Ee": _emscripten_glGetSynciv,
    "De": _emscripten_glGetTexParameterfv,
    "Ce": _emscripten_glGetTexParameteriv,
    "Be": _emscripten_glGetTransformFeedbackVarying,
    "Ae": _emscripten_glGetUniformBlockIndex,
    "ze": _emscripten_glGetUniformIndices,
    "ye": _emscripten_glGetUniformLocation,
    "xe": _emscripten_glGetUniformfv,
    "we": _emscripten_glGetUniformiv,
    "ve": _emscripten_glGetUniformuiv,
    "ue": _emscripten_glGetVertexAttribIiv,
    "te": _emscripten_glGetVertexAttribIuiv,
    "se": _emscripten_glGetVertexAttribPointerv,
    "re": _emscripten_glGetVertexAttribfv,
    "qe": _emscripten_glGetVertexAttribiv,
    "pe": _emscripten_glHint,
    "oe": _emscripten_glInvalidateFramebuffer,
    "ne": _emscripten_glInvalidateSubFramebuffer,
    "me": _emscripten_glIsBuffer,
    "le": _emscripten_glIsEnabled,
    "ke": _emscripten_glIsFramebuffer,
    "je": _emscripten_glIsProgram,
    "ie": _emscripten_glIsQuery,
    "he": _emscripten_glIsQueryEXT,
    "ge": _emscripten_glIsRenderbuffer,
    "fe": _emscripten_glIsSampler,
    "ee": _emscripten_glIsShader,
    "de": _emscripten_glIsSync,
    "ce": _emscripten_glIsTexture,
    "be": _emscripten_glIsTransformFeedback,
    "ae": _emscripten_glIsVertexArray,
    "$d": _emscripten_glIsVertexArrayOES,
    "_d": _emscripten_glLineWidth,
    "Zd": _emscripten_glLinkProgram,
    "Yd": _emscripten_glPauseTransformFeedback,
    "Xd": _emscripten_glPixelStorei,
    "Wd": _emscripten_glPolygonOffset,
    ...
    "L": _glDeleteShader,
    "Vb": _glDeleteTextures,
    "Ub": _glDepthFunc,
    "Tb": _glDepthMask,
    "Sb": _glDisable,
    "Rb": _glDisableVertexAttribArray,
    "Qb": _glDrawArrays,
    "Pb": _glDrawElements,
    "Ob": _glEnable,
    ...
    "$a": _glfwGetWindowRefreshRate,
    "ia": _glfwGetWindowSize,
    "_a": _glfwIconifyWindow,
    "Za": _glfwInitJS,
    "Ya": _glfwOpenWindow,
...
var _dmExportedSymbols = Module["_dmExportedSymbols"] = function() {
    return (_dmExportedSymbols = Module["_dmExportedSymbols"] = Module["asm"]["ji"]).apply(null, arguments)
};
...
var _dmScript_Html5ReportOperationSuccess = Module["_dmScript_Html5ReportOperationSuccess"] = function() {
    return (_dmScript_Html5ReportOperationSuccess = Module["_dmScript_Html5ReportOperationSuccess"] = Module["asm"]["pi"]).apply(null, arguments)
};
var _dmScript_RunInteractionCallback = Module["_dmScript_RunInteractionCallback"] = function() {
    return (_dmScript_RunInteractionCallback = Module["_dmScript_RunInteractionCallback"] = Module["asm"]["qi"]).apply(null, arguments)
};
var _htons = Module["_htons"] = function() {
    return (_htons = Module["_htons"] = Module["asm"]["ri"]).apply(null, arguments)
};
var _ntohs = Module["_ntohs"] = function() {
    return (_ntohs = Module["_ntohs"] = Module["asm"]["si"]).apply(null, arguments)
};
var _JSWriteDump = Module["_JSWriteDump"] = function() {
    return (_JSWriteDump = Module["_JSWriteDump"] = Module["asm"]["ti"]).apply(null, arguments)
};
